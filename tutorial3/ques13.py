...
def compute_square_root():
    try:
        ...
        messagebox.showerror("Oops!", "❗ Please enter a valid non-negative number.")

root = tk.Tk()
root.title(" Square Root Calculator")

tk.Label(root, text="Enter a non-negative number:").pack(pady=5)
input_entry = tk.Entry(root, font=("Arial", 12))
input_entry.pack(pady=5)

compute_button = tk.Button(root, text="Calculate Square Root", command=compute_square_root)
